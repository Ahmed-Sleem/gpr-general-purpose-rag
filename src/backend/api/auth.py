...
Provides 2-Step Authentication endpoints (`research/06_authentication.md`) and API Key live verification:
...
- `POST /api/v1/auth/check-api`: Live connection verification against DeepSeek, Groq, or OpenAI models.
"""
...
try:
    ...
    from ..models.auth import (
        ...
        LoginStep2Request, LoginStep2Response, CheckApiRequest, CheckApiResponse
    )
...
async def check_api_connection(payload: CheckApiRequest):
    """Verify live API connection and key validity for DeepSeek, Groq, or OpenAI."""
    ...
    try:
        if provider == "gemini":
            ...
            async with httpx.AsyncClient(timeout=8.0) as http_client:
                ...
                # If model name failed, try fallback with gemini-1.5-flash
